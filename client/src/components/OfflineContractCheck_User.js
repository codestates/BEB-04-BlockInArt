  ...
  return (
    <div className="offlineContract_container">
      ...
      <div className="contractDetail">
        매수인과 작가 간의 작품 매매계약서 매수인 [구매자 본명] (이하
        ‘매수인’)과 작가 [작가 본명](이하 ‘작가’)는 아래와 같이 미술작품의
        매매계약을 체결한다. 제1조(목적) 본 계약은 매도인인 작가가 매수인에게
        미술작품(이하 ‘작품’)의 소유권을 이전하고 매수인이 작가에게 그 대금을
        지급함에 있어서 필요한 제반 사항과 당사자의 권리 및 의무를 규율함에
        목적이 있다. 제2조(매매 대상 작품) 작가는 클레이튼 네트워크에 등록된 본
        트랜잭션에 [작품명]으로 작품명이 명시된 작품 1점을 매수인에게 매도한다.
